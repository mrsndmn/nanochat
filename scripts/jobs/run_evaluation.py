...
if __name__ == "__main__":
    ...
    # /workspace-SR004.nfs2/d.tarasov/nanochat-artifacts-low-rank-unembedding), so the symlink is auto-created
    ...
    base_dir_local = "/workspace-SR004.nfs2/d.tarasov/nanochat-artifacts-low-rank-unembedding"
