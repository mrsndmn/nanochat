...
train_loader = tokenizing_distributed_data_loader_with_state_bos_bestfit(tokenizer, args.device_batch_size, args.max_seq_len, split="train", device=device, resume_state_dict=dataloader_resume_state_dict, gist_token_ids=gist_token_ids_tuple, gist_placement=args.gist_placement)
    ...
    if last_step or (step > 0 and step != args.resume_from_step and args.save_every > 0 and step % args.save_every == 0):
        save_checkpoint(
            ...
            { # metadata saved as json
                ...
                "val_loss": val_loss, # nats/token over real tokens at last step (fair metric)
